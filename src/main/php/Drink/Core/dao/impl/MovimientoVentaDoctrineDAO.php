...
use Drink\Core\dao\IMovimientoVentaDAO;

use Drink\Core\model\MovimientoVenta;

use Drink\Core\model\ConceptoMovimiento;

use Drink\Core\dao\IConceptoMovimientoDAO;
...
//		}
	...
	public function getTotalesCajaVentasOnlineCtaCte( Caja $caja ){
		...
		try {
			...
			$queryBuilder->andWhere( "cp.oid=" .  DrinkUtils::CTS_CATEGORIA_PRODUCTO_VENTAS_ONLINE );	
