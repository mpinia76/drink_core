 ...
 */
class Vendedor extends \Drink\Core\model\Vendedor implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Drink\\Core\\model\\Vendedor' . "\0" . 'comision', '' . "\0" . 'Drink\\Core\\model\\Vendedor' . "\0" . 'nombre', '' . "\0" . 'Drink\\Core\\model\\Vendedor' . "\0" . 'mail', '' . "\0" . 'Drink\\Core\\model\\Vendedor' . "\0" . 'telefono', '' . "\0" . 'Drink\\Core\\model\\Vendedor' . "\0" . 'direccion', '' . "\0" . 'Drink\\Core\\model\\Vendedor' . "\0" . 'mayorista'];
        }
