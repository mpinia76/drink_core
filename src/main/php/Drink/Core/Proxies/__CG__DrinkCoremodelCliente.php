 ...
 */
class Cliente extends \Drink\Core\model\Cliente implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Drink\\Core\\model\\Cliente' . "\0" . 'nombre', '' . "\0" . 'Drink\\Core\\model\\Cliente' . "\0" . 'tipoCliente', '' . "\0" . 'Drink\\Core\\model\\Cliente' . "\0" . 'tipoDocumento', '' . "\0" . 'Drink\\Core\\model\\Cliente' . "\0" . 'documento', '' . "\0" . 'Drink\\Core\\model\\Cliente' . "\0" . 'cuit', '' . "\0" . 'Drink\\Core\\model\\Cliente' . "\0" . 'sexo', '' . "\0" . 'Drink\\Core\\model\\Cliente' . "\0" . 'mail', '' . "\0" . 'Drink\\Core\\model\\Cliente' . "\0" . 'telefono', '' . "\0" . 'Drink\\Core\\model\\Cliente' . "\0" . 'celular', '' . "\0" . 'Drink\\Core\\model\\Cliente' . "\0" . 'laboral', '' . "\0" . 'Drink\\Core\\model\\Cliente' . "\0" . 'localidad', '' . "\0" . 'Drink\\Core\\model\\Cliente' . "\0" . 'direccion', '' . "\0" . 'Drink\\Core\\model\\Cliente' . "\0" . 'nacimiento', '' . "\0" . 'Drink\\Core\\model\\Cliente' . "\0" . 'fecha', '' . "\0" . 'Drink\\Core\\model\\Cliente' . "\0" . 'ultModificacion', '' . "\0" . 'Drink\\Core\\model\\Cliente' . "\0" . 'observaciones', '' . "\0" . 'Drink\\Core\\model\\Cliente' . "\0" . 'cuentaCorriente'];
        }
