 ...
 */
class Gasto extends \Drink\Core\model\Gasto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Drink\\Core\\model\\Gasto' . "\0" . 'fecha', '' . "\0" . 'Drink\\Core\\model\\Gasto' . "\0" . 'fechaVencimiento', '' . "\0" . 'Drink\\Core\\model\\Gasto' . "\0" . 'monto', '' . "\0" . 'Drink\\Core\\model\\Gasto' . "\0" . 'estado', '' . "\0" . 'Drink\\Core\\model\\Gasto' . "\0" . 'observaciones', '' . "\0" . 'Drink\\Core\\model\\Gasto' . "\0" . 'user', '' . "\0" . 'Drink\\Core\\model\\Gasto' . "\0" . 'concepto'];
        }
