 ...
 */
class MarcaProducto extends \Drink\Core\model\MarcaProducto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Drink\\Core\\model\\MarcaProducto' . "\0" . 'nombre'];
        }
