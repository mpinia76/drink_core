 ...
 */
class TipoProducto extends \Drink\Core\model\TipoProducto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Drink\\Core\\model\\TipoProducto' . "\0" . 'nombre'];
        }
