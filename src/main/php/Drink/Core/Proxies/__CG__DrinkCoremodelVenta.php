 ...
 */
class Venta extends \Drink\Core\model\Venta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Drink\\Core\\model\\Venta' . "\0" . 'fecha', '' . "\0" . 'Drink\\Core\\model\\Venta' . "\0" . 'cliente', '' . "\0" . 'Drink\\Core\\model\\Venta' . "\0" . 'monto', '' . "\0" . 'Drink\\Core\\model\\Venta' . "\0" . 'montoPagado', '' . "\0" . 'Drink\\Core\\model\\Venta' . "\0" . 'montoDebe', '' . "\0" . 'Drink\\Core\\model\\Venta' . "\0" . 'ganancia', '' . "\0" . 'Drink\\Core\\model\\Venta' . "\0" . 'montoDevolucion', '' . "\0" . 'Drink\\Core\\model\\Venta' . "\0" . 'montoActualizado', '' . "\0" . 'Drink\\Core\\model\\Venta' . "\0" . 'estado', '' . "\0" . 'Drink\\Core\\model\\Venta' . "\0" . 'observaciones', '' . "\0" . 'Drink\\Core\\model\\Venta' . "\0" . 'vendedor', '' . "\0" . 'Drink\\Core\\model\\Venta' . "\0" . 'comision', '' . "\0" . 'Drink\\Core\\model\\Venta' . "\0" . 'user', '' . "\0" . 'Drink\\Core\\model\\Venta' . "\0" . 'detalles', '' . "\0" . 'Drink\\Core\\model\\Venta' . "\0" . 'devoluciones'];
        }
     ...
     * {@inheritDoc}
     */
    public function addDetalle(\Drink\Core\model\DetalleVenta $detalle)
    {
     ...
     * {@inheritDoc}
     */
    public function addDevolucion(\Drink\Core\model\DevolucionVenta $devolucion)
    {
