 ...
 */
class Producto extends \Drink\Core\model\Producto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Drink\\Core\\model\\Producto' . "\0" . 'fecha', '' . "\0" . 'Drink\\Core\\model\\Producto' . "\0" . 'codigo', '' . "\0" . 'Drink\\Core\\model\\Producto' . "\0" . 'tipoProducto', '' . "\0" . 'Drink\\Core\\model\\Producto' . "\0" . 'marcaProducto', '' . "\0" . 'Drink\\Core\\model\\Producto' . "\0" . 'nombre', '' . "\0" . 'Drink\\Core\\model\\Producto' . "\0" . 'descripcion', '' . "\0" . 'Drink\\Core\\model\\Producto' . "\0" . 'iva', '' . "\0" . 'Drink\\Core\\model\\Producto' . "\0" . 'stock', '' . "\0" . 'Drink\\Core\\model\\Producto' . "\0" . 'stockMinimo', '' . "\0" . 'Drink\\Core\\model\\Producto' . "\0" . 'precioLista', '' . "\0" . 'Drink\\Core\\model\\Producto' . "\0" . 'precioEfectivo', '' . "\0" . 'Drink\\Core\\model\\Producto' . "\0" . 'costo', '' . "\0" . 'Drink\\Core\\model\\Producto' . "\0" . 'porcentajeGanancia', '' . "\0" . 'Drink\\Core\\model\\Producto' . "\0" . 'porcentajeGanancia2', '' . "\0" . 'Drink\\Core\\model\\Producto' . "\0" . 'vencimiento', '' . "\0" . 'Drink\\Core\\model\\Producto' . "\0" . 'cantidad'];
        }
