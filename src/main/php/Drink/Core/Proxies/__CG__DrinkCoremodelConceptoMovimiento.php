 ...
 */
class ConceptoMovimiento extends \Drink\Core\model\ConceptoMovimiento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Drink\\Core\\model\\ConceptoMovimiento' . "\0" . 'nombre'];
        }
