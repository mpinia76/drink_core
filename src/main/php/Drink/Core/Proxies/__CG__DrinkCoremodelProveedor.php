 ...
 */
class Proveedor extends \Drink\Core\model\Proveedor implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Drink\\Core\\model\\Proveedor' . "\0" . 'nombre', '' . "\0" . 'Drink\\Core\\model\\Proveedor' . "\0" . 'tipoDocumento', '' . "\0" . 'Drink\\Core\\model\\Proveedor' . "\0" . 'documento', '' . "\0" . 'Drink\\Core\\model\\Proveedor' . "\0" . 'razonSocial', '' . "\0" . 'Drink\\Core\\model\\Proveedor' . "\0" . 'cuit', '' . "\0" . 'Drink\\Core\\model\\Proveedor' . "\0" . 'condicionIva', '' . "\0" . 'Drink\\Core\\model\\Proveedor' . "\0" . 'sexo', '' . "\0" . 'Drink\\Core\\model\\Proveedor' . "\0" . 'mail', '' . "\0" . 'Drink\\Core\\model\\Proveedor' . "\0" . 'telefono', '' . "\0" . 'Drink\\Core\\model\\Proveedor' . "\0" . 'celular', '' . "\0" . 'Drink\\Core\\model\\Proveedor' . "\0" . 'laboral', '' . "\0" . 'Drink\\Core\\model\\Proveedor' . "\0" . 'localidad', '' . "\0" . 'Drink\\Core\\model\\Proveedor' . "\0" . 'direccion', '' . "\0" . 'Drink\\Core\\model\\Proveedor' . "\0" . 'nacimiento', '' . "\0" . 'Drink\\Core\\model\\Proveedor' . "\0" . 'fecha', '' . "\0" . 'Drink\\Core\\model\\Proveedor' . "\0" . 'ultModificacion', '' . "\0" . 'Drink\\Core\\model\\Proveedor' . "\0" . 'observaciones', '' . "\0" . 'Drink\\Core\\model\\Proveedor' . "\0" . 'cuentaCorriente'];
        }
