 ...
 */
class Combo extends \Drink\Core\model\Combo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Drink\\Core\\model\\Combo' . "\0" . 'precio', '' . "\0" . 'Drink\\Core\\model\\Combo' . "\0" . 'fecha', '' . "\0" . 'Drink\\Core\\model\\Combo' . "\0" . 'nombre', '' . "\0" . 'Drink\\Core\\model\\Combo' . "\0" . 'productos'];
        }
     ...
     * {@inheritDoc}
     */
    public function addProducto(\Drink\Core\model\ProductoCombo $detalle)
    {
