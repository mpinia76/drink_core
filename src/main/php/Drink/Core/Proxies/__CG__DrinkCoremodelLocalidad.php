 ...
 */
class Localidad extends \Drink\Core\model\Localidad implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Drink\\Core\\model\\Localidad' . "\0" . 'nombre', '' . "\0" . 'Drink\\Core\\model\\Localidad' . "\0" . 'provincia'];
        }
