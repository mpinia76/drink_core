 ...
 */
class ConceptoGasto extends \Drink\Core\model\ConceptoGasto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Drink\\Core\\model\\ConceptoGasto' . "\0" . 'nombre'];
        }
