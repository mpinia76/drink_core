 ...
 */
class Pedido extends \Drink\Core\model\Pedido implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Drink\\Core\\model\\Pedido' . "\0" . 'fechaHora', '' . "\0" . 'Drink\\Core\\model\\Pedido' . "\0" . 'proveedor', '' . "\0" . 'Drink\\Core\\model\\Pedido' . "\0" . 'monto', '' . "\0" . 'Drink\\Core\\model\\Pedido' . "\0" . 'montoDebe', '' . "\0" . 'Drink\\Core\\model\\Pedido' . "\0" . 'estado', '' . "\0" . 'Drink\\Core\\model\\Pedido' . "\0" . 'observaciones', '' . "\0" . 'Drink\\Core\\model\\Pedido' . "\0" . 'user', '' . "\0" . 'Drink\\Core\\model\\Pedido' . "\0" . 'detalles', '' . "\0" . 'Drink\\Core\\model\\Pedido' . "\0" . 'fechaHoraRecibido', '' . "\0" . 'Drink\\Core\\model\\Pedido' . "\0" . 'userRecibio'];
        }
     ...
     * {@inheritDoc}
     */
    public function addDetalle(\Drink\Core\model\DetallePedido $detalle)
    {
