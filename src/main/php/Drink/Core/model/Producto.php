 ...
 * Producto
 * 
 * @Entity @Table(name="drink_producto")
 * 
 * @author Marcos
 */
...
class Producto extends Entity{
    ...
    /**
     * @ManyToOne(targetEntity="Drink\Core\model\TipoProducto",cascade={"detach"})
    ...
    /**
     * @ManyToOne(targetEntity="Drink\Core\model\MarcaProducto",cascade={"detach"})
	...
	private $descripcion;
	 ...
	 /**
     * @ManyToOne(targetEntity="Drink\Core\model\Iva",cascade={"detach"})
	...
	{
		/*$parametroDolar = DrinkUtils::getPrecioDolar();
	    $parametroPorcentaje = DrinkUtils::getPorcentajePrecioLista();
