...
class VentaServiceImpl extends CrudService implements IVentaService {
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Drink/Core/service/Drink\Core\service.IVentaService::cobrar()
	 */
	public function cobrar(Venta $venta, Cuenta $cuenta, User $user, $montoPagar, $montoActualizado){
		...
		if ($vendedor->getComision()) {
			$cuentaComision = DrinkUtils::getCuentaUnica();
			...
			$movimiento->setConcepto( DrinkUtils::getConceptoMovimientoComisionVenta() );
	...
	public function anular(Venta $venta, User $user){
		...
		if( $venta->getMonto() > $venta->getMontoDebe() ){
			...
			foreach ($movimientos as $movimiento) {
				...
				//Logger::log('Comparar conceptos: '.$movimiento->getConcepto()->getOid().'=='.DrinkUtils::DRINK_CONCEPTO_MOVIMIENTO_VENTA);
				$concepto = ($movimiento->getConcepto()->getOid()==DrinkUtils::DRINK_CONCEPTO_MOVIMIENTO_VENTA)?DrinkUtils::getConceptoMovimientoAnulacionVenta() :DrinkUtils::getConceptoMovimientoAnulacionComisionVenta();
...
/**
	 * (non-PHPdoc)
	 * @see src/main/php/Drink/Core/service/Drink\Core\service.IVentaService::devolver()
	 */
	public function devolver(Venta $venta, Cuenta $cuenta, User $user){
		...
		if( $venta->getMontoDevolucion() > $venta->getMontoDebe() ){
			...
			$movimiento->setConcepto( DrinkUtils::getConceptoMovimientoDevolucion() );
			$movimiento->setUser($user);
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Drink/Core/service/Drink\Core\service.IVentaService::cobrarCtaCte()
	 */
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Drink/Core/service/Drink\Core\service.IVentaService::getTotalesDia()
	 */
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Drink/Core/service/Drink\Core\service.IVentaService::getTotalesMes()
	 */
