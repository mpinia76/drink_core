...
use Drink\Core\model\MovimientoPedido;
...
use Drink\Core\service\IPedidoService;
...
class PedidoServiceImpl extends CrudService implements IPedidoService {
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Drink/Core/service/Drink\Core\service.IPedidoService::pagar()
	 */
	public function pagar(Pedido $pedido, Cuenta $cuenta, User $user){
		...
		$movimiento->setConcepto( DrinkUtils::getConceptoMovimientoPedido() );
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Drink/Core/service/Drink\Core\service.IPedidoService::anular()
	 */
	public function anular(Pedido $pedido, User $user){
		...
		if( $pedido->getEstado() == EstadoPedido::Pagado ){
			...
			$contramovimiento->setConcepto( DrinkUtils::getConceptoMovimientoAnulacionPedido() );
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Drink/Core/service/Drink\Core\service.IPedidoService::recibir()
	 */
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Drink/Core/service/Drink\Core\service.IPedidoService::anularRecibir()
	 */
